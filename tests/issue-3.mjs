...
const tests = [
  ...
  ["Word downloads use Blob object URL and download attribute", () => { assert.match(documentOutput, /new Blob/); assert.match(documentOutput, /URL\.createObjectURL/); assert.match(documentOutput, /link\.download/); assert.match(documentOutput, /application\/msword/); }],
